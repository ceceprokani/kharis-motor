                    ...
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-start justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                <router-link :to="{name: 'brand.add'}" class="btn btn-primary button-rounded">Tambah Baru</router-link>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr v-for="item, index in list">
                                                ...
                                                <td class="middle-item" v-if="['superadmin', 'admin'].indexOf($store.state.user?.role?.toLowerCase()) != -1">
                                                    <div class="d-flex justify-content-end align-items-center">
                                                        <router-link :to="`brand/form/${item.id}`" type="button" class="btn btn-square border bg-primary text-white me-2"><i class="ri-edit-circle-line fs-4"></i></router-link>
